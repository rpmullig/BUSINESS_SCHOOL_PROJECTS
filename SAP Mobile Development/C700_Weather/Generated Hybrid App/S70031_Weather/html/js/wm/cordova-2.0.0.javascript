...
function createEvent(type, data) {
	return data;
	// Windows mobile doesn't support this method
    ...
    each(objects, function (obj, key) {
        try {
          ...
          if (clobber) {
			...
			/* On WM, some keys in parent are defined as "javascript:void(0)", that would make some
			   features cannot work.
			*/
            if ((typeof parent[key] == 'undefined') || (parent[key] == "javascript:void(0)")) {
              parent[key] = result;
...
module.exports = function(success, fail, service, action, args) {
    ...
    try{
	     ...
	     var command = service + "/" + action + "/" + callbackId + "/" + encodeURIComponent(argsString);
	        // pass it on to Notify
	     xmlhttp = getXMLHTTPRequest();
	     xmlhttp.open("PhoneGap", command, true);
	     xmlhttp.send("");
    }catch(exception){
    	alert("PhoneGap.exec:" + exception.message);
    }
};
...
//require("cordova/plugin/wm/DOMStorage");

// Fix XHR calls to local file-system
require("cordova/plugin/wm/XHRPatch");
...
module.exports = {
    ...
    objects: {
        CordovaCommandResult: {
            path:"cordova/plugin/wm/CordovaCommandResult"
        },
        CordovaMediaonStatus: {
            path:"cordova/plugin/wm/CordovaMediaonStatus"
        },
        navigator: {
            children: {
                device: {
                ...
                console: {
                    path: "cordova/plugin/wm/console"
        ...
        FileTransfer: {
            path: 'cordova/plugin/wm/FileTransfer'
        }
    }
};
...
// file: lib\wm\plugin\wm\CordovaCommandResult.js
define("cordova/plugin/wm/CordovaCommandResult", function(require, exports, module) {

var cordova = require('cordova');
var channel = require('cordova/channel');

// singular wm callback function attached to window, status is used to determin if it is a success or error
module.exports = function(status,callbackId,args,cast) {
	...
	{
		console.log("CordovaCommandResult(args=" + callbackId);
		...
		{
			console.log("Phonegap Callback: Message from Server: " + args);
            console.log("Phonegap back Error: "+e);
			return ;
		}
	}
	else if(typeof args != "object")
	{
		// this should not happen for PhoneGap Command Result.
		return ;
	}
	
	if ((!args.message) && (args.cacheKey)){
		console.log("CordovaCommandResult(args.cacheKey=" + args.cacheKey);

		var thisService = "LargeDataStore";
		var thisAction = "requestData";
		var thisArgs = {id:args.cacheKey};
		var thisCallbackId = thisService + PhoneGap.callbackId++;
	
	    var command = thisService + "/" + thisAction + "/" + thisCallbackId + "/" + JSON.stringify(thisArgs);
		console.log(command);

		xmlHttpReq = getXMLHTTPRequest();
		xmlHttpReq.open("PhoneGap", command, false );
        xmlHttpReq.send("");

	    var response = xmlHttpReq.responseText;
	    var responseAsJson = null;
	    try{
...
// file: lib\wm\plugin\wm\CordovaMediaonStatus.js
define("cordova/plugin/wm/CordovaMediaonStatus", function(require, exports, module) {
...
// file: lib\common\plugin\FileTransfer.js
define("cordova/plugin/wm/FileTransfer", function(require, exports, module) {
var exec = require('cordova/exec'),
    FileTransferError = require('cordova/plugin/FileTransferError');
...
// file: lib\common\plugin\FileUploadOptions.js
define("cordova/plugin/wm/FileUploadOptions", function(require, exports, module) {
/**
 * Options to customize the HTTP request used to upload files.
 * @constructor
 * @param fileKey {String}   Name of file request parameter.
...
// file: lib\wm\plugin\wm\XHRPatch.js
define("cordova/plugin/wm/XHRPatch", function(require, exports, module) {
...
// file: lib\wm\plugin\wm\console.js
define("cordova/plugin/wm/console", function(require, exports, module) {
